        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center lg:flex-row lg:items-center lg:text-left -mt-24">
          <div class="lg:basis-1/2 pb-10 md:pb-16">
            ...
            <div class="max-w-xs sm:max-w-md flex flex-col sm:flex-row sm:justify-center gap-4 lg:justify-start">
              <a class="btn btn-primary w-full" href="https://github.com/onwidget/qwind" target="_blank" rel="noopener">
                Start Etching
              </a>
