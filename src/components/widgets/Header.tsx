...
<header
  ...
  class={`sticky top-0 z-40 flex-none relative border-2 overflow-hidden ${
    store.isScrolling
      ? "bg-gradient-to-r from-primary via-bgAccent to-secondary border-transparent px-0 py-0 md:backdrop-blur-sm"
      : "bg-gradient-to-r from-primary via-bgAccent to-secondary shadow-md"
