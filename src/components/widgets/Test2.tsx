    ...
    <Carousel class="!h-96" pauseOnHover>
        ...
        >
          <div class="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
            ...
            ></div>
            <div
              class="absolute inset-y-0 right-1/2 -z-10 mr-12 w-[150vw] origin-bottom-left skew-x-[-30deg] shadow-xl ring-1 sm:mr-20 md:mr-0 lg:right-full lg:-mr-36 lg:origin-center"
              style={{
                backgroundColor: `var(--color-bg-primary, white)`,
                boxShadow: `0 0 60px 0 var(--color-accent-shadow, rgba(0, 0, 0, 0.1))`,
              }}
            ></div>
            <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
              ...
              <figcaption class="text-base lg:col-start-1 lg:row-start-3">
                <div class="font-semibold text-gray-900">Bonnie Green</div>
        ...
        >
          <div class="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
            ...
            <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
              ...
              <figcaption class="text-base lg:col-start-1 lg:row-start-3">
                <div class="font-semibold text-gray-900">Johnathon Smith</div>
                <div class="mt-1 text-gray-500">CEO of BigCommerce</div>
              </figcaption>
            </figure>
          </div>
        </section>
