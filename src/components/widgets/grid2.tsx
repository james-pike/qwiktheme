...
<div class="grid-background absolute inset-0 p-2 -mt-16 grid grid-cols-6 gap-1 transform -skew-y-6 scale-100">
      ...
      <div class="max-w-3xl mx-auto lg:mt-24 bg-bgLight rounded-lg p-6">
