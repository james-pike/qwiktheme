            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6">
                <div class="pb-2 md:py-0">
                    ...
                    <div class="max-w-3xl mx-auto p-0 rounded-md shadow-xl bg-white dark:bg-gray-900">
                        ...
                        <h2 class="text-4xl md:text-4xl font-bold text-center leading-tighter tracking-tighter py-8 my-0 font-heading">
                            <span class="text-primary-500 pt-0">Pricing</span>
                            <br class="block sm:hidden" />
                        </h2>
                        <p class="text-xl text-gray-600 text-center dark:text-slate-400 pt-2">
