        ...
        <section class="relative bg-bgAccent py-0 sm:pb-20">
            <div class="max-w-7xl mx-auto px-2 sm:px-6">
                <div class="pb-2 md:py-0">
                    ...
                    <div class="max-w-3xl mx-auto p-0 rounded-md shadow-xl bg-bgAccent dark:bg-gray-900">
                        
                        <div class="bg-gradient-to-r from-bgAccent to-secondary px-1 rounded-t-lg">
                        <h2 class="text-4xl md:text-4xl font-bold text-center leading-tighter rounded-2xl tracking-tighter pt-4 my-2 font-heading">
                            <span class="text-primary-500 pt-6">Pricing</span>
